 ...
 */
public class NarrowDialogFragment extends BaseDialogFragment {

    private DialogFragmentBasicBinding binding;

    public static NarrowDialogFragment newInstance() {
        NarrowDialogFragment f = new NarrowDialogFragment();
        return f;
    }
