...
public class RecyclerViewDecorationDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new QuickAdapter.OnItemClickListener<String>() {
            ...
            public void onItemClick(View view, int position, String data) {
                Toast.makeText(RecyclerViewDecorationDemo.this, data, Toast.LENGTH_SHORT).show();
            }
        });
        recyclerView.setAdapter(adapter);
        recyclerView.addItemDecoration(new DemoDecoration(this));
