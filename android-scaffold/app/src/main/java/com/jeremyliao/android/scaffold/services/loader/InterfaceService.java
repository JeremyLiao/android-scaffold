...
import com.jeremyliao.android.scaffold.services.loader.core.exception.InterfaceLoadException;
...
public class InterfaceService<T> extends Binder {
    ...
    public static <R> InterfaceService<R> newService(@NonNull Class<R> interfaceType, @NonNull R implement) {
