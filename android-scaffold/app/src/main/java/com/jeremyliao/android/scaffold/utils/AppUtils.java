...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final BaseUtils.OnAppStatusChangedListener listener) {
        BaseUtils.getActivityLifecycle().addOnAppStatusChangedListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        BaseUtils.getActivityLifecycle().removeOnAppStatusChangedListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        BaseUtils.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        BaseUtils.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        PackageManager packageManager = BaseUtils.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(BaseUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(BaseUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return BaseUtils.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        BaseUtils.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = BaseUtils.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(BaseUtils.getApp().getPackageName());
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(BaseUtils.getApp().getPackageName());
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = BaseUtils.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(BaseUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return BaseUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(BaseUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(BaseUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(BaseUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(BaseUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(BaseUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(BaseUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(BaseUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(BaseUtils.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(BaseUtils.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = BaseUtils.getApp().getPackageName() + ".utilcode.provider";
            data = FileProvider.getUriForFile(BaseUtils.getApp(), authority, file);
            intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        }
        BaseUtils.getApp().grantUriPermission(BaseUtils.getApp().getPackageName(), data, Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = BaseUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) BaseUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(BaseUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) BaseUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) BaseUtils.getApp()
