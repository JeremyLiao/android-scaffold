...
public final class DeviceUtils {
    ...
    public static boolean isAdbEnabled() {
        return Settings.Secure.getInt(
                BaseUtils.getApp().getContentResolver(),
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            final WifiManager wifi = (WifiManager) BaseUtils.getApp()
    ...
    public static void reboot() {
        ...
        BaseUtils.getApp().sendBroadcast(intent);
    }
    ...
    public static void reboot(final String reason) {
        PowerManager pm = (PowerManager) BaseUtils.getApp().getSystemService(Context.POWER_SERVICE);
