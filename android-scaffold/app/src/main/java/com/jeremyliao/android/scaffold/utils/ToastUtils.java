...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = BaseUtils.getApp().getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(BaseUtils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(BaseUtils.getApp());
                iToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) BaseUtils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private static final BaseUtils.OnActivityDestroyedListener LISTENER =
                new BaseUtils.OnActivityDestroyedListener() {
                    @Override
        ...
        public void show() {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                ...
                Context topActivityOrApp = BaseUtils.getTopActivityOrApp();
                ...
                BaseUtils.getActivityLifecycle().addOnActivityDestroyedListener(topActivity, LISTENER);
            } else {
                mWM = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
            ...
            mParams.packageName = BaseUtils.getApp().getPackageName();
